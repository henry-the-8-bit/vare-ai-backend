...
const metadata: PlatformMetadata = {
  ...
  description: "Make your products discoverable in Microsoft Copilot conversations. Vare handles the integration — just toggle it on.",
  icon: "Bot",
  type: "pull",
};
...
function buildOpenApiSpec(baseUrl: string): Record<string, unknown> {
  ...
  return {
    openapi: "3.1.0",
    info: {
      title: "Vare AI Product Catalog API - Copilot Plugin",
      description: "Search, browse, and retrieve product catalog data across merchants via Microsoft Copilot. Includes pricing, inventory, automotive fitment, and more.",
      version: "1.0.0",
    },
    servers: [{ url: baseUrl }],
    paths: {
